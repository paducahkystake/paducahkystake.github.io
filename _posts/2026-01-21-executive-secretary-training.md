...
1. Login to the church website: [https://www.churchofjesuschrist.org](https://www.churchofjesuschrist.org)
2. Click on "Resources", then "Leader and Clerk Resources". The LCR website will load. 
3. Click on the "Temple" menu, then "Temple Recommend Status". See screenshot below. 
4. Filter to the needed report: "Expiring within 1 month", "Expiring in 3 months", etc. 
![](../assets/temple-recommend-status-menu.png)
...
1. Be Reliable. 
2. Be Proactive. In other words, don't wait to be asked to act. Ex: ask initially if it's ok to proactively set appointments based on the Action/Interview list, then go and do. Same for youth birthday list, etc. 
3. Be Present. Show up to leadership meetings. Bishop/Branch Presidency, Ward/branch council, etc

And here are the rest of the duties (in order of importance to the Bishops/Branch Presidents)

4. Be in the building during my interviews.
5. Prepare meeting agendas and follows up on action items
6. Be first point of contact to set appointments
7. Manage appointments on my calendar
8. Help with seminary and institute matters (registration, etc)
9. Knock on my door when my meeting is running long
10. Keep a list of members in the military and circulates to the ward/branch council
